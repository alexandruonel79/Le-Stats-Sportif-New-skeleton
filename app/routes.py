...
def get_response(job_id):
    ...
    job_id = int(job_id)
    webserver.logger.info("(/api/get_results/%d): Requested solution for job_%d.", job_id, job_id)
    ...
    webserver.logger.info("(/api/get_results/%d): Received solution for job_%d.", job_id, job_id)
    return jsonify(res)
